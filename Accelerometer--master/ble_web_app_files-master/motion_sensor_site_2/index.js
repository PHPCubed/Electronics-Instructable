...
// 	}
	...
	let tempTime = fullDate1[fullDate1.length - 1];
...
//                console.log(accDataSmothed1[accDataSmothed1.length - 1]);
    ...
    downloadButton.onclick = e => {
        ...
        if (ti_sensortag1 !== undefined) {
            ...
            text += generatingTime(fullDate1, n, 'time');
        }
    ...
    function generatingTime(data, size, name) {
        var x = name;
        for (var i = 0; i < size; i++) {
            x += ' ' + data[i];
        }
